		...
		<?php } // End if has_post_format(video) ?>
			...
			<ul class="hkb-entry-meta clearfix">
				...
				<li class="hkb-em-date"> 
				    <span><?php _e( 'Создано' , 'helpguru' ) ?></span>
				...
				<li class="ht-kb-em-author">
					<span><?php _e( 'Автор' , 'helpguru' ) ?></span>
				...
				<?php if( !is_tax() ) : ?>
					<li class="ht-kb-em-category">
					    <span><?php _e( 'Категория' , 'helpguru' ) ?></span>
					    <?php 
						    $terms = get_the_term_list( $post->ID, 'ht_kb_category', ' ', ', ', '' );
						    if(empty($terms)){
						    	_e('Без категории', 'helpguru');
						    } else {
						    	echo $terms;
						    }
					    ?>
				...
				<?php if ( comments_open() && get_comments_number() > 0 ){ ?>
					<li class="ht-kb-em-comments">
					    <span><?php _e( 'Комментарии' , 'helpguru' ) ?></span>
