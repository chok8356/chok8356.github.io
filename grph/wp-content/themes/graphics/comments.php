...
<?php endif; // have_comments() ?>
	...
	$comments_args = array(
		...
		'comment_field' => '<p class="comment-form-comment"><textarea id="comment" name="comment" placeholder="'. __( 'Ваш комментарий', 'helpguru' ) .'" cols="45" rows="5" aria-required="true"></textarea></p>',
		'name_submit'          => 'submit',
		'class_submit'         => 'submit',
